...
* 33
/U/, [[file:img/fig146.png]], is the authorised contraction for “under”, whether as a word, prefix, or a part of a word, e.g. X /under/, X /understand/, X /blunder/, X /thunder/.
...
When the outline X, /i/, cuts the ruled line _initially_ it adds the letter “n”, e.g. X /in/, X /in the/, X /in the case of/.

With other letters cutting the ruled line of writing, the prefixes ‘an’, ‘en’, or ‘in’ are indicated. Thus, X /anvil/, X /endure/, X /infirm/, etc.
* 40
